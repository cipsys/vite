(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('defu'), require('fs'), require('pathe'), require('magic-string'), require('@rollup/pluginutils'), require('estree-walker'), require('@module-federation/sdk'), require('@module-federation/dts-plugin'), require('@module-federation/dts-plugin/core'), require('url')) :
  typeof define === 'function' && define.amd ? define(['exports', 'defu', 'fs', 'pathe', 'magic-string', '@rollup/pluginutils', 'estree-walker', '@module-federation/sdk', '@module-federation/dts-plugin', '@module-federation/dts-plugin/core', 'url'], factory) :
  (global = global || self, factory(global.vite = {}, global.defu, global.fs, global.pathe, global.magicString, global.pluginutils, global.estreeWalker, global.sdk, global.dtsPlugin, global.core, global.url));
})(this, (function (exports, defu, fs, path, MagicString, pluginutils, estreeWalker, sdk, dtsPlugin, core, url) {
        ...
        try {
          ...
          return Promise.resolve(function () {
            if (importer === REMOTE_ENTRY_ID && !id.startsWith('.') && !id.startsWith('/') && !id.startsWith('\0') && !id.startsWith('virtual:')) {
              var importPath = typeof __filename === 'string' ? __filename : url.fileURLToPath((typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('index.umd.js', document.baseURI).href)));
